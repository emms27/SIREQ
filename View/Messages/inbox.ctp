...
<h3 class="page-header page-header-top"><i class="fa fa-inbox"></i> Bandeja de Entrada<small>    En la bandeja de entrada muestra una línea temporal de todas los mensajes recibidos de la sección de contacto del  Sistema desde el principio de los tiempos.</small></h3>

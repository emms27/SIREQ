...
<br><br>
<?php
 echo $this->Form->create('InvoiceProduct',array('action'=>'add',"class"=>"form-horizontal form-box"));
...
<div class="form-group">
 <label class="control-label col-md-2">Folio Factura</label>
    <?php
...
<div class="form-group">
 ...
 <div class="col-md-5">
  <div class="input-group">
                  <?php
		  echo $this->Form->input('fcantidad',
				          array('label' =>false,
						'type'=>'text',
				                //'title'=>"Introducir también los centavos",
						'size'=>'5',
